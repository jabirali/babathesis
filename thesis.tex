...
\setmathfont{STIX Two Math}[StylisticSet=8]
\setmathfont{STIX Two Math}[StylisticSet=5,range={\uparrow,\downarrow}]
\setmathfont{WarnockPro-Regular}[range={\mathup/{num,latin,Latin},\times,\mathdollar,\mathpercent,\mathampersand,\mathcomma,\mathperiod,\mathslash,\mathcolon,\mathsemicolon,\backslash,\mathatsign,\ell,\dagger,\ddagger}]
\setmathfont{WarnockPro-It}[range=\mathit/{num,latin,Latin}]
\setmathfont{WarnockPro-Bold}[range=\mathbfup/{num,latin,Latin}]
\setmathfont{WarnockPro-BoldIt}[range=\mathbfit/{num,latin,Latin}]
