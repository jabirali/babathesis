...
\renewcommand*{\chapterformat}{\sbox\feline@chapter{\feline@chapter@marker[1.5cm]}\makebox[0pt][l]{\makebox[\dimexpr\textwidth+1.5\marginparsep+\wd\feline@chapter\relax][r]{\usebox\feline@chapter}}}
