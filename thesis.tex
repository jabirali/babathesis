...
\setmathfont{STIX Two Math}[StylisticSet=5,range={\uparrow,\downarrow}]
\setmathfont{WarnockPro-Regular}[range={\mathup/{num,latin,Latin,Greek},\times,\mathdollar,\mathpercent,\mathampersand,\mathcomma,\mathperiod,\mathslash,\mathcolon,\mathsemicolon,\backslash,\mathatsign,\ell,\dagger,\ddagger}]
\setmathfont{WarnockPro-It}[range=\mathit/{num,latin,Latin,Greek}]
\setmathfont{WarnockPro-Bold}[range=\mathbfup/{num,latin,Latin,Greek}]
\setmathfont{WarnockPro-BoldIt}[range=\mathbfit/{num,latin,Latin,Greek}]
\setmathfont{WarnockPro-It}[range=\mathcal,Style=Swash]
\setmathfont{WarnockPro-BoldIt}[range=\mathbfcal,Style=Swash]
...
\AtBeginDocument{\let\varepsilon=\epsilon}
...
% Switch to an italic font for footnotes
\addtokomafont{footnote}{\itshape}

% Change footnote marks to letters
...
\deffootnote{2.15em}{2.15em}{\addfontfeature{Numbers={Lining}}\thefootnotemark.\kern0.75em\addfontfeature{Numbers=OldStyle}}
...
% Switch font used for hyperlinks
\urlstyle{sf}
...
\mhchemoptions{textfontcommand=\addfontfeatures{Numbers={Lining,Proportional}}}
