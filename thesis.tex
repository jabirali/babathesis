...
\setmathfont[range={\lparen,\rparen,\lbrace,\rbrace,\lbrack,\rbrack,\langle,\rangle,\vert,\pm,\mp}]{Libertinus Math}
\setmathfont[range={up,bfup,cal,bfcal,\nabla,\partial,\mathslash}]{Neo Euler} 
\setmathfont[range={\mathcomma,\mathperiod,\mathcolon,\mathsemicolon,\mathpercent,\mathampersand}]{WarnockPro}
