...
% Reduce the default size of the headings
%\KOMAoptions{headings=normal}

% TODO:
%   * Place chapter numbers in the margin (hanging chapter numbers) to 
%     make it more distinct from the section numbers
%   * Or, if that is hard wrt. margins, place the chapnum to the right

%\makeatletter
%\newsavebox{\feline@chapter}
%\newcommand\feline@chapter@marker[1][4cm]{\sbox\feline@chapter{\resizebox{!}{#1}{\setlength{\fboxsep}{0pt}\colorbox{white}{\color{gray}\thechapter}}}\raisebox{-5mm}{\usebox{\feline@chapter}}}
