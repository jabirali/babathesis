...
%]
\setsansfont{Libertinus Sans}[Numbers={Lining},Scale=MatchUppercase]
%\setsansfont{Alegreya Sans}[Scale=MatchUppercase,BoldFont={*-Medium.otf}]
\setmathfont{Libertinus Math}
\setmathfont{LibertinusBaba.otf}[range={\uparrow,\downarrow,\dagger,\ast,\nabla,"0302,"0303,"030C}] 
\setmathfont{STIX2Baba.otf}[range={"0067,"1D488,"1D454},StylisticSet=2]
