...
% Allow variable page heights
\raggedbottom

% Override \raggedright and \raggedleft with hyphenated variants
...
% Block style (whether to put entries on new lines)
%\PassOptionsToPackage[block=nbpar]{biblatex}
...
%\PassOptionsToPackage{isbn=false}{biblatex}
%\PassOptionsToPackage{url=false}{biblatex}
%\PassOptionsToPackage{eprint=true}{biblatex}
...
% Use oldstyle figures in the bibliography
%\renewcommand*{\bibfont}{\osfstyle}
...
\definecolor{whiteish}{rgb}{0.972, 0.925, 0.761}
...
\defbibheading{papers}[Papers]{\chapter*{#1}}
\newcommand{\printcites}{\printbibliography[nottype=customa,resetnumbers=true]}
\newcommand{\printpapers}{\printbibliography[type=customa,heading=papers,resetnumbers=true]}
