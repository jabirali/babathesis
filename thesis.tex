...
\setmathfont{LibertinusBaba.otf}[range={\uparrow,\downarrow,\coloneq,\eqcolon,"0302,"0303,"030C,"0067,"1D488,"1D454}] 
%\setmathfont{LibertinusBaba.otf}[range={\uparrow,\downarrow,\dagger,\ast,\nabla,\coloneq,\eqcolon,"0302,"0303,"030C,"0067,"1D488,"1D454}] 
...
\renewcommand{\d}[1]{\mathop{\textrm{d}\kern0em#1}}
