...
\setsansfont{Linux Biolinum O}[Scale=1.03]
%\setsansfont[Scale=MatchUppercase]{Fira Sans}
\setmathfont{STIX Two Math}[StylisticSet=8]
\setmathfont{STIX Two Math}[StylisticSet=5,range={\uparrow,\downarrow}]
\setmathfont{WarnockPro-Regular}[range={\mathup/{num,latin,Latin},\mathdollar,\mathpercent,\mathampersand,\mathcomma,\mathperiod,\mathslash,\mathcolon,\mathsemicolon,\backslash,\mathatsign,\ell,\dagger,\ddagger}]
...
%\settocstylefeature{entryhook}{\addfontfeature{Numbers=OldStyle}}
%\settocstylefeature{pagenumberhook}{\addfontfeature{Numbers=OldStyle}}
%\settocstylefeature[0]{entryhook}{\bfseries}
%\settocstylefeature[0]{pagenumberhook}{\bfseries\addfontfeature{Numbers=OldStyle}}
...
\RedeclareSectionCommand[beforeskip=-0.5\baselineskip,afterskip=0.0\baselineskip]{chapter}
