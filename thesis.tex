...
% Page numbers
\addtokomafont{pagenumber}{\addfontfeatures{Numbers=Lining}\vspace{3.5ex}}
...
% Load fallback font
%\usepackage[scaled=0.96]{newtxmath}
...
%\setmainfont[Renderer=Basic,Ligatures=TeX,Numbers={OldStyle,Proportional}]{WarnockPro} 
%\setmonofont[Scale=0.95]{Prestige Elite Std}
%\setmathfont{STIX Two Math}
%\setmathfont[range=\mathup/{latin,Latin,greek,Greek,num}]{WarnockPro-Disp}

%\setsansfont{Linux Biolinum O}[Scale=1.06]
%\setmainfont{STIX Two Text}
%\setmathfont{STIX Two Math}[StylisticSet=8]
%\setmathfont{STIX Two Math}[StylisticSet=5,range={\uparrow,\downarrow}]
...
\setmainfont[Ligatures=TeX,Numbers={OldStyle,Proportional}]{WarnockPro} 

% Sans-serif font used for titling
\setsansfont{Linux Biolinum O}[Numbers={Lining,Proportional},Scale=1.015]

% Mathematical fallback font
\setmathfont{STIX Two Math}[StylisticSet={4,8}]

% Mathematical font used for Latin letters and Arabic numerals
\setmathfont{WarnockPro-Regular}[range={up/{Latin,latin,num},\times,\mathdollar,\mathpercent,\mathampersand,\mathcomma,\mathperiod,\mathslash,\mathcolon,\mathsemicolon,\backslash,\mathatsign,\ell,\dagger,\ddagger}]
\setmathfont{WarnockPro-It}[range={it/{Latin,latin,num}}]
\setmathfont{WarnockPro-Bold}[range={bfup/{Latin,latin,num}}]
\setmathfont{WarnockPro-BoldIt}[range={bfit/{Latin,latin,num}}]

% Mathematical font used for Greek letters
\setmathfont{MinionPro-Regular}[range={up/{Greek,greek}}]
\setmathfont{MinionPro-It}[range={it/{Greek,greek}}]
\setmathfont{MinionPro-Bold}[range={bfup/{Greek,greek}}]
\setmathfont{MinionPro-BoldIt}[range={bfit/{Greek,greek}}]

% Mathematical font used for specific glyphs
\setmathfont{STIX Two Math}[StylisticSet=5,range={\uparrow,\downarrow,"1D713,"1D74D,"1D6D9,"03C8}]

% Mathematical font used for calligraphic letters
\setmathfont{WarnockPro-It}[range=cal,Style=Swash]
\setmathfont{WarnockPro-BoldIt}[range=bfcal,Style=Swash]

% Mathematical font used for blackboard letters
\setmathfont{WarnockPro-Bold}[range=bb->bfup]
...
%\usepackage{biolinum}
%\usepackage{MyriadPro}
%\usepackage[openg,footnotefigures,italicgreek,swash,textosf,mathlf]{MinionPro}
%\usepackage{MnSymbol}
...
\settocstylefeature{entryhook}{\addfontfeature{Numbers={Lining,Tabular}}}
\settocstylefeature{pagenumberhook}{\addfontfeature{Numbers={OldStyle,Proportional}}}
\settocstylefeature[0]{entryhook}{\bfseries\addfontfeature{Numbers={Lining,Tabular}}}
\settocstylefeature[0]{pagenumberhook}{\bfseries\addfontfeature{Numbers={OldStyle,Proportional}}}
...
\newcommand{\feline@chapter@marker}[1][4cm]{\sbox\feline@chapter{\resizebox{!}{#1}{\setlength{\fboxsep}{0pt}\color{gray}\thechapter}}\parbox[b][1.5cm]{1.5cm}{\usebox{\feline@chapter}\vspace*{-0.5cm}}}
...
%    \ifblank{#2}{}
%    {%
%      \decofourleft\;\,\mbox{Chapter~{#2}\!}\decofourright \\
%    }
%    \mbox{#3}
%  \end{center}
%}%
...
\renewcommand{\thefootnote}{\addfontfeature{Numbers={Lining}}{\arabic{footnote}}}
...
% Use lining numerals for chemicals and units
\mhchemoptions{textfontcommand=\addfontfeatures{Numbers={Lining}}}
\sisetup{text-rm=\addfontfeature{Numbers=Lining}}
