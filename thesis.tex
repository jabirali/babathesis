...
\usepackage{euler}                   % Euler math font     -- used for almost all mathematical symbols
...
% Replace the Euler brackets with nicer Palatino ones
...
% Make sure footnote marks are separated by commas
\usepackage{fnpct}
