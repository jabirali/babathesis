...
\usepackage[utf8]{eulerpx/eulerpx}   % Euler math font     -- used for almost all mathematical symbols 
...
% Make sure all headers use sans text and math
\addtokomafont{disposition}{\sffamily\sfmath}
