...
%To generalize to systems with spin-orbit coupling, we only need to replace the derivatives $\nabla \rightarrow \nabla - i[\U{A}, \,\cdot\,]$ above, which results in the additional terms:
%\begin{align}
%  \U{S}\, &\rightarrow \U{S} - i\U{G}^R [\U{A}, \U{G}^R] \U{H} + i\U{H} \U{G}^A [\U{A}, \U{G}^A],  \\
%  \U{R}\, &\rightarrow \U{R} - i[\U{A}, \U{H}] + i\U{G}^R [\U{A}, \U{H}] \U{G}^A.
%\end{align}
%Finally, in one-dimensional systems, we can let $\nabla \rightarrow \partial_z$ and $\U{A} \rightarrow \U{A}_z$.
...
The final result above should however still be correct.
