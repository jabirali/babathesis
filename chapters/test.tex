...
\begin{align}
  \nabla\cdot\B{D}  &= \rho, & 
  \nabla\times\B{E} &= 0 - \partial_{{\kern-0.075em}t{\kern0.04em}}\B{B};\\
  \nabla\cdot\B{B}  &= 0, &
  \nabla\times\B{H} &= \B{J} + \partial_{{\kern-0.075em}t{\kern0.04em}}\B{D}.
\end{align}

\begin{figure}[t!]
  \centering
  \includegraphics[width=\textwidth]{../Plots/test.pdf}
  \caption
  {
